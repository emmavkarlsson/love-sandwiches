...
SHEET = GSPREAD_CLIENT.open('ove_sandwiches')
...
def get_last_5_entries_sales():
    ...
    the 5 last entries for each sandwich and return the data
    as a list of lists
    """
...
def calculate_stock_data(data):
    """
    Calculate the average for each item type, adding 10%
    """
